class Adyen::PaymentResult
  ...
  def has_valid_signature?(shared_secret = nil)
    @params[:merchantSig] == signature(shared_secret)
  end
  ...
  def signature(shared_secret = nil)
    ...
    Adyen::Encoding.hmac_base64(shared_secret, signature_string)
  end
